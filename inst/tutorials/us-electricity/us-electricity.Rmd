...
If you take this exercise as part of a graded item in a course, see the Grading section in online notes.
...
Using Rmarkdown, render into `html` a one or two page concise summary to be sent to clients. 
...
+ To compute the monthly changes use the absolute change instead of percentages and beware whether datea are sorted ascending or descending before computing changes.
...
This is an advanced class in your learning in your degree and/or professional workplace and you are judged both on absolute and relative standards versus your peers.

```{r, echo=F,include=TRUE, fig.height=3}
tibble(
  Competency = c("Summary",
                 "Presentation",
                 "Accuracy code and results"),
  Measure = c(
    ...
    "Accurate implementation for each of the four questions."
  ),
  Score = c("2.5 points",
            "7.5 points",
            "10 points")
